...
echo "  2. Onboard a component: helm install festoji ./charts/component-onboarding --set componentName=festoji --set gitRepoUrl=https://github.com/FORK_ORG/festoji"
